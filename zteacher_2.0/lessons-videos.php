    ...
    <div class="container">
        <div class="row">
            <div class="videos-gallery children-videos-gallery">
                ...
                <a class="venobox" data-autoplay="true" data-vbtype="video" data-gall="desktopVideoGallery" href="">
    ...
    <div class="container">
        <div class="row">
            <div class="videos-gallery older-videos-gallery">
                <a class="venobox" data-autoplay="true" data-vbtype="video" data-gall="VideoGallery-older" href="">
                  <div class="gallery-video"><i class="bi bi-youtube"></i></div> <!-- 1 -->
                </a>
                <a class="venobox" data-autoplay="true" data-vbtype="video" data-gall="VideoGallery-older" href="">
                  <div class="gallery-video"><i class="bi bi-youtube"></i></div> <!-- 2 -->
                ...
                <a class="venobox" data-autoplay="true" data-vbtype="video" data-gall="VideoGallery-older" href="https://youtu.be/vFX2Ynnff38">
                  <div class="gallery-video"><i class="bi bi-youtube"></i></div> <!-- 7 -->
                </a>
                <a class="venobox" data-autoplay="true" data-vbtype="video" data-gall="VideoGallery-older" href="">
                  <div class="gallery-video"><i class="bi bi-youtube"></i></div> <!-- 8 -->

    ...
    <div class="container">
        <div class="row">
            <div class="videos-gallery children-videos-gallery">
                ...
                <a class="venobox" data-autoplay="true" data-vbtype="video" data-gall="desktopVideoGallery" href="https://youtu.be/EPrfAAcATpo" data-aos="fade-up">
                ...
                <a class="venobox d-none d-lg-flex" data-autoplay="true" data-vbtype="video" data-gall="desktopVideoGallery" href="https://youtu.be/tiiRHGLJgAg" data-aos="fade-down">
    ...
    <div class="container">
        <div class="row">
            <div class="videos-gallery older-videos-gallery">
                <a class="venobox" data-autoplay="true" data-vbtype="video" data-gall="VideoGallery-older" href="https://youtu.be/yFiMfhrgW-s" data-aos="fade-right">
                  <div class="gallery-video"><i class="bi bi-youtube"></i></div> <!-- 1 -->
                </a>
                <a class="venobox" data-autoplay="true" data-vbtype="video" data-gall="VideoGallery-older" href="https://youtu.be/pCwQ3CigHmA" data-aos="fade-up">
                  <div class="gallery-video"><i class="bi bi-youtube"></i></div> <!-- 2 -->
                </a>
                <a class="venobox" data-autoplay="true" data-vbtype="video" data-gall="VideoGallery-older" href="https://youtu.be/rBmwiuFCKDc" data-aos="fade-left">
                  <div class="gallery-video"><i class="bi bi-youtube"></i></div> <!-- 3 -->
                </a>
                <a class="venobox d-none d-lg-flex" data-autoplay="true" data-vbtype="video" data-gall="VideoGallery-older" href="https://youtu.be/miHR2Rxx388" data-aos="fade-right">
                  <div class="gallery-video"><i class="bi bi-youtube"></i></div> <!-- 4 -->
                </a>
                <a class="venobox d-none d-lg-flex" data-autoplay="true" data-vbtype="video" data-gall="VideoGallery-older" href="https://youtu.be/mXV60C-Vees" data-aos="fade-in">
                  <div class="gallery-video"><i class="bi bi-youtube"></i></div> <!-- 5 -->
                </a>
                <a class="venobox d-none d-lg-flex" data-autoplay="true" data-vbtype="video" data-gall="VideoGallery-older" href="https://youtu.be/0uRf7sNZ2XM" data-aos="fade-left">
                  <div class="gallery-video"><i class="bi bi-youtube"></i></div> <!-- 6 -->
                </a>
                <a class="venobox d-none d-lg-flex" data-autoplay="true" data-vbtype="video" data-gall="VideoGallery-older" href="https://youtu.be/vFX2Ynnff38" data-aos="fade-right">
                  <div class="gallery-video"><i class="bi bi-youtube"></i></div> <!-- 7 -->
                </a>
                <a class="venobox d-none d-lg-flex" data-autoplay="true" data-vbtype="video" data-gall="VideoGallery-older" href="" data-aos="fade-down">
                  <div class="gallery-video"><i class="bi bi-youtube"></i></div> <!-- 8 -->
                </a>
                <a class="venobox d-none d-lg-flex" data-autoplay="true" data-vbtype="video" data-gall="VideoGallery-older" href="" data-aos="fade-left">
                  <div class="gallery-video"><i class="bi bi-youtube"></i></div> <!-- 9 -->
                </a>
            </div>
        </div>

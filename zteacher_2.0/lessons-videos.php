    ...
    <div class="container">
        <div class="row">
            <div class="videos-gallery older-videos-gallery">
                <a class="venobox" data-autoplay="true" data-vbtype="video" data-gall="VideoGallery-older" href="https://youtu.be/yFiMfhrgW-s">
                  <div class="gallery-video"><i class="bi bi-youtube"></i></div> <!-- 1 -->
                </a>
                <a class="venobox" data-autoplay="true" data-vbtype="video" data-gall="VideoGallery-older" href="https://youtu.be/pCwQ3CigHmA">
                  <div class="gallery-video"><i class="bi bi-youtube"></i></div> <!-- 2 -->
                </a>
                <a class="venobox" data-autoplay="true" data-vbtype="video" data-gall="VideoGallery-older" href="https://youtu.be/rBmwiuFCKDc">
                  <div class="gallery-video"><i class="bi bi-youtube"></i></div> <!-- 3 -->
                </a>
                <a class="venobox d-none d-lg-flex" data-autoplay="true" data-vbtype="video" data-gall="VideoGallery-older" href="https://youtu.be/miHR2Rxx388">
                  <div class="gallery-video"><i class="bi bi-youtube"></i></div> <!-- 4 -->
                </a>
                <a class="venobox d-none d-lg-flex" data-autoplay="true" data-vbtype="video" data-gall="VideoGallery-older" href="https://youtu.be/mXV60C-Vees">
                  <div class="gallery-video"><i class="bi bi-youtube"></i></div> <!-- 5 -->
                </a>
                <a class="venobox d-none d-lg-flex" data-autoplay="true" data-vbtype="video" data-gall="VideoGallery-older" href="https://youtu.be/0uRf7sNZ2XM">
                  <div class="gallery-video"><i class="bi bi-youtube"></i></div> <!-- 6 -->
                </a>
                <a class="venobox d-none d-lg-flex" data-autoplay="true" data-vbtype="video" data-gall="VideoGallery-older" href="https://youtu.be/vFX2Ynnff38">
                  <div class="gallery-video"><i class="bi bi-youtube"></i></div> <!-- 7 -->
                </a>
